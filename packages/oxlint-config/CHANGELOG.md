...
- [#83](https://github.com/jabworks/style-guide/pull/83) [`4ce5eeb`](https://github.com/jabworks/style-guide/commit/4ce5eebfca2a40edac890ebb29966da7855887c4) Thanks [@vi-hieu](https://github.com/vi-hieu)! - Split Expo's conventions out of `reactNative` into a new `expo` preset.
...
- [#79](https://github.com/jabworks/style-guide/pull/79) [`ce49c05`](https://github.com/jabworks/style-guide/commit/ce49c05c3b22ac14ef2e15b32666f2e149b592f5) Thanks [@vi-hieu](https://github.com/vi-hieu)! - Add two opt-in layers for mobile apps that run ESLint-style plugins through oxlint's JS plugin support.
